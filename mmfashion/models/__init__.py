...
from .registry import (ATTRPREDICTOR, BACKBONES, CONCATS, EMBEDEXTRACTOR,
                       FEATURECORRELATION, FEATUREEXTRACTOR, FEATURENORM,
                       FEATUREREGRESSION, GEOMETRICMATCHING, GLOBALPOOLING,
                       LANDMARKDETECTOR, LOSSES, PREDICTOR, RECOMMENDER,
                       RETRIEVER, ROIPOOLING, TPSWARP, TRYON,
...
__all__ = [
    ...
    'TRYON'
    'build_backbone', 'build_global_pool', 'build_roi_pool', 'build_concat',
    'build_attr_predictor', 'build_cate_predictor', 'build_embed_extractor',
    'build_predictor', 'build_retriever', 'build_landmark_feature_extractor',
    'build_landmark_regression', 'build_visibility_classifier',
    'build_landmark_detector', 'build_loss', 'build_triplet_net',
    'build_type_specific_net', 'build_fashion_recommender',
    'build_feature_extractor', 'build_feature_correlation',
    'build_feature_norm', 'build_feature_regression', 'build_tps_warp',
    'build_geometric_matching', 'build_tryon',
