...
data = dict(
    ...
    train=dict(type=dataset_type,
               ...
               img_size=img_size,
               text_feat_path=os.path.join(data_root, 'disjoint/train_hglmm_pca6000.txt'),
               text_feat_dim=6000,
               compatibility_test_fn=os.path.join(data_root, 'disjoint/compatibility_train.txt'),
               fitb_test_fn=os.path.join(data_root, 'disjoint/fill_in_blank_train.json'),
    ...
    test=dict(type=dataset_type,
              ...
              text_feat_path=None,
              text_feat_dim=6000,
              compatibility_test_fn=os.path.join(data_root, 'disjoint/compatibility_test.txt'),
              fitb_test_fn=os.path.join(data_root, 'disjoint/fill_in_blank_test.json'),
              typespaces_fn=os.path.join(data_root, 'disjoint/typespaces.p'),
              train=False),
    val=dict(type=dataset_type,
             ...
             text_feat_path=None,
             text_feat_dim=6000,
             compatibility_test_fn=os.path.join(data_root, 'disjoint/compatibility_valid.txt'),
             fitb_test_fn=os.path.join(data_root, 'disjoint/fill_in_blank_valid.json'),
             typespaces_fn=os.path.join(data_root, 'disjoint/typespaces.p'),
             train=False))
