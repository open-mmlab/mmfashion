...
from .test_predictor import test_cate_attr_predictor, test_predictor
from .test_retriever import test_retriever
from .test_virtual_tryon import test_geometric_matching, test_tryon
...
from .train_virtual_tryon import train_geometric_matching, train_tryon
...
__all__ = [
    ...
    'test_geometric_matching', 'test_tryon', 'train_geometric_matching',
    'train_tryon', 'build_optimizer', 'build_criterion'
]
